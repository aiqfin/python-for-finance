...
\section{Qoder CN 桌面端与 VS Code 协作}

\begin{frame}{认识 Qoder CN 桌面端}
  \begin{columns}[T,totalwidth=\textwidth]
    ...
    \begin{column}{0.35\textwidth}
      \textbf{用自然语言协作}\par
      描述目标，让 AI 理解项目、编写代码、解释报错并辅助修改。
      \vspace{0.3cm}\par
      \textbf{围绕本地文件工作}\par
      关联项目文件夹，AI 的修改保存为电脑上的实际文件。
      \vspace{0.3cm}\par
      \textbf{配合 VS Code}\par
      学生打开这些文件，阅读代码、运行程序并检查结果。
    \end{column}
  \end{columns}
  \vspace{0.25cm}
...
\begin{frame}{下载桌面端，并关联课程项目}
  \begin{enumerate}
    \item 打开 \href{https://qoder.cn/download}{\textbf{qoder.cn/download}}，选择 \textbf{Qoder CN 桌面端}对应的产品卡片。官网同时列出 IDE 等产品，请核对名称。
  \end{enumerate}
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.48\textwidth}
      \begin{block}{Windows}
