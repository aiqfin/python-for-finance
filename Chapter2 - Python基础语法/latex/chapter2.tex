...
\begin{frame}[fragile]{变量：给数据起名字}
	\begin{itemize}
		\item \textbf{变量}是对象的名字：用 \texttt{=} 把名字绑定到右侧对象。
...
\item \url{https://wesmckinney.com/book/python-builtin}
